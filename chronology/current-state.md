...
The campaign is paused at the present-day continuity endpoint.

This is the intended cold-open point for relaunch.

## Date

**Arodus 4, 4712 AR**

The final fork beat is around **2:28 PM**, when Rak hears something ahead.

Historical live-session labels used Arodus 5. The objective date is corrected by `chronology/bonewrack-arodus-4-date-lock.md`.
...
**Bonewrack Isle** and the **Man's Promise**.

## Party Split

### Bonewrack Isle — Harvus Group

- Harvus G'ron
- Mirei
- Sandara Quinn, rescued from the grindylow caverns
- Tilly Brackett, rescued from the grindylow caverns
- Goyle Onorach, rescued from the grindylow caverns
...
Fipps remains at Coconut Beach / the south-beach rendezvous. Syl ordered him to stay because the ship was expected there.

### Man's Promise — Sho

- Sho Astor
- Kahina Bukekayo nearby or recently guarding her

Sho is aboard the Man's Promise after being beaten unconscious by Scourge's shore party. She is believed confined in or around the hot-box.

Kahina has issued a life-for-life test: if Sho truly repents, she must be willing to act against those tormenting the survivors and risk her life. If Sho hesitates, Kahina has threatened to ensure Sho dies for her sins.

Exact guard state after Kahina leaves remains unresolved.

## Immediate Cold Open

The relaunch begins with simultaneous split scenes:

1. Harvus and Mirei returning from the successful rescue with Sandara, Tilly, and Goyle.
2. Rak guiding the hostile or semi-hostile recovery party, with Syl commanding and Jape/Shivikah present.
...
- Slippery Syl Lonegan's violent opportunism and tactical command.
- Bonewrack's remaining hazards.
- Fipps at the expected ship rendezvous.
- Survivor anger toward the PCs and Plugg.
- The practical risk that no faction has enough reliable sailors to hold or move the ship.

## Known Critical Revelations

- Plugg appears to have betrayed Harrigan by changing course.
- Sandara and Kroop suspected the course change.
- Mirei was pressured into serving Plugg and was tasked with proving loyalty by betraying or killing the other PCs.
- Mirei confessed after the rescue and did not act on the order.
...
Do not use a major time skip as the primary relaunch model.

The campaign should return at or very near this split-party convergence on **Arodus 4, 4712 AR**.
