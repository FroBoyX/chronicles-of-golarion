...
- Maturity: Working index, updated with Harvus no-AI-generation restriction
...
| harvus-post-riptide-portrait-v1 | Character Art | Harvus G'ron | Portrait / commission reference | visual-briefs/characters/harvus-gron.md |  |  | No AI generation | Player-safe after rescue reveal | Do not route to AI generation; use only for human commission, manual art direction, or player-approved non-AI process | Harvus player does not permit AI image generation; brief retained as visual direction only. |
| ambrose-fishguts-kroop-portrait-v1 | Character Art | Ambrose "Fishguts" Kroop | Full-body NPC character plate | visual-briefs/characters/ambrose-fishguts-kroop.md | art/characters/ambrose-fishguts-kroop-portrait-v1.png |  | Briefed | Player-safe as isolated portrait | No remake without GM request; use official/AP image as controlled identity reference only | Strong AP visual scaffold; preserve Kroop identity cues without direct-copying official art. |
