...
| fipps-chumlett-portrait-v1 | Character Art | Fipps Chumlett | Full-body portrait / NPC plate | visual-briefs/characters/fipps-chumlett.md |  |  | Briefed | Player-safe as isolated portrait; GM-only if tied to Coconut Beach current-state scene | No remake without GM request | Next recommended character test; use Syl only as house style baseline, not likeness. |
