...
|---|---|---|---|---|---|---|---|---|---|---|
| sho-hotbox-portrait-v1 | Character Art | Sho Astor | Portrait | visual-briefs/characters/sho-astor.md | ChatGPT generated draft, pending GM archival path | Intended first character portrait anchor if approved | Draft | Player-safe if cropped/context-controlled | No remake without GM request | Suggested pilot; generated as first draft from current visual brief; not approved visual canon. |
