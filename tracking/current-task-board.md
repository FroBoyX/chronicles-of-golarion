...
Update this file when a task becomes active, is completed, or is moved to another chat.

This is not a full open-question index. Use `tracking/open-questions.md` for unresolved canon questions.
...
Create or verify concise dossiers for all six named survivors and ensure `state/current-npc-locations.md` and `state/crew-transfer-and-loyalty-audit.md` agree.
