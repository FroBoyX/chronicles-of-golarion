...
Nor'gal represents the cost of piracy from the other side.
...
During the Man's Promise battle, Rak intimidated or forced a sailor identified as Nor'gal to surrender.
...
Nor'gal is useful if the campaign needs to prevent the Man's Promise survivors from becoming a simple ally bloc.
