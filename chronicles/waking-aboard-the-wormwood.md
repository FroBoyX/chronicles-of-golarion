...
Plugg stopped in front of each of them in turn.

He looked each one in the eyes for an unsettling moment.

Then he asked whether they could cook.

Each of them, in one way or another, answered no.

Plugg did not allow the answer to inconvenience him.

The Wormwood's cook, **Ambrose "Fishguts" Kroop**, had been unusually drunk as of late. Worse, he had been failing to provide adequately for the officers' meals. To Plugg, this was not a problem to tolerate. It was a problem to correct.
...
There was distaste in the look.

Plugg had once encountered a true naga, and the memory did the new hand no favors. The hybrid before him added nothing pleasant to that old impression. Putting the snake in the galley would keep contact to a minimum.

That was as good a reason as any.

Plugg's mind quickly manufactured a better excuse, as if uncomfortable with its own discomfort.

The snake looked well-fed.

Therefore, the snake must be able to cook.

And so it was decided.

The swabs would report to **Master Scourge**.

The riggers would report to **Mr. Plugg**.

The snake would report to **Mr. Kroop**.
...
- Kroop's drunken unreliability was already visible to officers.
- The chain of command was made clear early:
  - swabs to Scourge,
  - riggers to Plugg,
  - cook's mate to Kroop.
- Rak's galley assignment created the path to Kroop and, indirectly, Grok.
