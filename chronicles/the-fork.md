...
The Fork is the current end of the campaign record and the intended cold-open point for relaunch.

It is not merely where play stopped. It is the point where the campaign changes from captivity and survival into free decision.
...
This group is returning from Riptide Cove after rescuing Sandara, Tilly, and Goyle.
...
Harvus is likely focused on Sandara, exhaustion, and the need to return.

Mirei is compromised but has chosen action against Plugg's expectations.

Sandara is rescued but recovering.
...
- Harvus rescued Sandara,
- Mirei confessed,
- Rak's exact current location,
- whether the supply party will return peacefully or violently.
...
## Immediate Questions for Play

- Does Rak hear or see Harvus' group first?
...
- the PCs reunite peacefully,
- the PCs remain a unified party,
- Plugg dies,
- Scourge dies,
- the PCs take the ship,
- the crew accepts PC command,
- the Man's Promise remains in play.

All of those are possible outcomes, but none are canon yet.

## Function of the Scene

The fork should return players to character memory through immediate stakes.

It should not begin with a lecture or recap.

The scene itself should remind them:

- they are split,
- they are not safe,
- people they saved are alive,
- Plugg and Scourge's plan is closing,
- and the future of the ship is undecided.
