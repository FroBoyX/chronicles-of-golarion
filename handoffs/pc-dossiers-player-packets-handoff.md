# PC Dossiers / Player Packets Handoff
...
Use this chat for PC-centered reconstruction and player-facing prep.

This chat should not ingest broad raw chronology unless it directly affects a PC dossier, player packet, or question set.
...
- `evidence/player-sheets/rak-wraithriser-foundry-export.md`

## PC Working Summaries

### Harvus G'ron

Core threads:

- Strix / hawk-man rigger.
- Press-ganged after tavern fight; Scourge damaged or twisted wing during boarding / handling.
- Scourge framed Harvus as needing to be "tamed."
- Calistrian revenge energy.
- Harvus / Rosie fiddle thread, Rosie storm loss, post-Rosie rage.
- Harvus / Sandara relationship deepened through injury care, grief, rage, and Bonewrack rescue.
- Current: returning from Riptide Cove with Mirei, Sandara, Tilly, and Goyle. Killed the Whale with Rak's spear.

Open player-packet needs:

- Shape Harvus cold-open memory without spoiling Rak group or Sho hot-box details.
- Clarify how Harvus feels about Mirei after confession.
- Clarify whether Harvus knows or suspects Plugg's manipulation scope.
- Track debt to Rak for lost spear / Whale kill.
...
- Nagaji alchemist / vivisectionist, Besmara, grandson of Baas'lisk.
- Cook's mate under Ambrose Kroop; did most cooking until Man's Promise.
- Grok relationship developed through cooking / alcohol / Ambrose / quartermaster loop.
- Day 2 brew scene is first recovered explicit friendship-development beat with Grok, not necessarily first contact.
- Later hooked up with Grok and bunked with her before Man's Promise split.
- Current: on Bonewrack with Shivikah, Syl, and Jape; Fipps left at Coconut Beach.
- Do not leak Whale/Riptide rescue details to Rak player before cold open.

Open player-packet needs:

- Rak player truth questions around Grok, Ambrose, Badger, Tilly, Sandara, Jack, Patch, Tate, Maheem.
- Clarify player/character knowledge of Giffer.
- Clarify attitude toward Harvus after spear loss if known.

### Sho Astor

Core threads:

- Suli monk from Jalmeray; disguised as a man early.
- Mirei noticed disguise early and Sho confided.
- Never drank rum; dumped or hid ration.
- Objected early to Jakes Magpie, likely warning not whipping.
- Later whipping exposed cries and likely made disguise harder to hide.
- Day 2 defeated Aretta; later bilges attack / Aretta death thread.
- Owlbear fight: showed mercy; Owlbear understood.
- Man's Promise boarding: command fracture, surrender promises not honored, Giffer killed by Rak from player knowledge but not character proof.
- Warned Harrigan in fog and received pendant / locket / captain's amulet.
- Current: believed locked in hot-box; Kahina tests her with life-for-life survivor bargain.

Open player-packet needs:

- Clarify exact "monk man" reference now identified as Ebony Saable.
- Clarify exact pendant / locket object and whether Sho still has it.
- Clarify whether Sho knows which surrendered sailors died and by whose hands.
- Preserve player/character knowledge split about Giffer.
