# Man's Promise / Bonewrack Handoff
...
- `evidence/gm-notes/mans-promise-survivor-set.md`
...
### Relationship / Character Targets
...
- `relationships/sho-kahina.md`
- `relationships/sho-harrigan.md`
