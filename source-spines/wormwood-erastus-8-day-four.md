# Wormwood Erastus 8: Day Four Source Spine
...
- If the warning was given on Erastus 5 / Day 1, then Erastus 8 fits.
- The Kipper / rum fragment and punishment scene strongly connect, but the exact gap between them is unresolved.
...
- The public discipline was tied to rum ration refusal or disposal.
- Scourge framed the rum ration as generosity.
...
- Confirm whether the "cat" line means cat-o'-nine-tails or another punishment term.
- Confirm whether the Mirei 34 performance occurred the same night as this punishment.
