# Wormwood Erastus 14: Day Ten Source Spine
...
The current early-Wormwood reconstruction places:

- Erastus 12 / Day 8: full storm and Rosie's loss at sea;
- Erastus 13 / Day 9: weakening storm, recovery labor, and Harvus seeking Sandara;
...
The AP weather scaffold assigns normal weather to structural Days 10 and 11.

Use Day 10 as the first ordinary workday after the storm:

- the horizon and stable weather return;
- watches and work assignments operate normally;
- remaining storm repairs continue within ordinary labor;
- officers offer no praise or formal remembrance;
- temporary cooperation from the crisis does not become reconciliation;
- Rosie's physical absence remains visible in the lower hold;
- the day restores the Wormwood's divisions, habits, and hierarchy.

## Strong Facts / Drafting Locks

- Weather is normal after the weakening storm.
- The bell and ordinary assignments resume.
- Harvus returns to rigging work while his wing remains painful.
- Rak returns fully to galley routine with Kroop.
- Sho works despite bruising from the rescue.
- Mirei returns to normal lower-crew work.
- Plugg and Scourge treat survival of the storm as expected duty rather than heroism.
- Peppery returns to the less visible specialist role she held before the emergency.
- Brief cooperation from the storm may be remembered, but it does not alter established hostility or loyalty.
- Rosie remains lost at sea, survival unresolved.
- Rosie's fiddle remains aboard unless later evidence establishes that it was moved.
- No formal memorial, funeral, or officer acknowledgment occurs.
- No recovered dialogue is securely tied to this day.

## Controlled Reconstruction

The narrative may use ordinary role-consistent labor to show routine returning:

- riggers replacing and testing lines;
- swabs cleaning salt, mud, and storm debris;
...
- Do not invent a major encounter.
- Do not place the Erastus 17 / recovered Day 12 Sho-Mirei-Owlbear scenes here.
- Do not confirm Rosie's death.
- Do not invent a formal search operation after the Wormwood has continued onward.
- Do not make former rivals friendly because they cooperated during the storm.
- Do not invent exact work failures, punishments, injuries, or dialogue.
...
| Rosie | Physically absent; represented by her remaining place and fiddle. |
