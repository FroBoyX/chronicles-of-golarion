...
Use this ledger to account for every named Wormwood-side person from the original crew roster and prevent the Man's Promise / Wormwood split from relying on invented background crew.
...
|---:|---|---|---|
| 1 | Barnabas Harrigan | Captain | Wormwood-side. |
| 2 | Mr. Plugg | First Mate | Man's Promise transfer; captain claimant. |
| 3 | Riaris Krine | Master Gunner | Wormwood-side likely. |
| 4 | Kipper | Master Gunner | Placement unresolved. |
| 5 | Peppery Longfarthing | Sailing Master | Wormwood-side likely. |
| 6 | Master Scourge | Boatswain / Master at arms | Man's Promise transfer; first mate / enforcer under Plugg. |
| 7 | Habbly Quarne, the "Stitchman" | Carpenter / Surgeon | Wormwood-side likely. |
| 8 | Cut-throat Grok | Quartermaster | Wormwood-side confirmed; parted from Rak. |
| 9 | Patch Patchsalt | Deck-officer Nightwatch | Placement unresolved. |
| 10 | Tam "Narwhal" Tate | Rigger | Man's Promise-side locked by post-split evidence; exact Arodus 5 position unresolved. |
| 11 | Maheem | Rigger | Placement unresolved. |
...
| 16 | Harvus G'ron | Rigger | Man's Promise transfer; Bonewrack Harvus group. |
| 17 | Sandara Quinn | Unknown, assumed Swab / possible Rigger / other | Man's Promise-side locked before abduction; Bonewrack Harvus group after rescue. |
| 18 | Tilly Brackett | Swab | Man's Promise-side locked before abduction; Bonewrack Harvus group after rescue. |
| 19 | Shivikah | Swab | Strong Man's Promise-side evidence; Bonewrack Rak group. |
| 20 | Rosie Cusswell | Swab | Dead / lost at sea before split. |
| 21 | Jaundiced Jape | Swab | Man's Promise-side locked; Bonewrack Rak group. |
| 22 | Jack Scrimshaw | Swab | Placement unresolved; Man's Promise evidence weak / possible displaced fragment. |
| 23 | Jakes Magpie | Swab | Dead; keelhauled Day 1. |
| 24 | Giffer Tibbs | Swab | Dead during Man's Promise boarding. |
| 25 | Crimson "Cog" Cogward | Swab | Man's Promise-side locked by post-split evidence; exact Arodus 5 position unresolved. |
| 26 | Aretta Bansion | Swab | Dead after Sho bilge conflict. |
| 27 | "Badger" Medlar | Swab | Probable Man's Promise-side, but low-placement confidence; not locked. |
| 28 | Sho Astor | Swab | Man's Promise transfer; hot-box at Arodus 5. |
| 29 | Mirei | Swab | Man's Promise transfer; Bonewrack Harvus group at Arodus 5. |
| 30 | "Caulky" Tarroon | Cabin-girl | Wormwood-side likely. |
...
| Character | Removal |
|---|---|
| Jakes Magpie | Keelhauled on Wormwood Day 1. |
| Rosie Cusswell | Lost at sea during Wormwood storm. |
...
|---|---|
| Mr. Plugg | Locked. |
| Master Scourge | Locked. |
| Ambrose Kroop | Locked. |
| Owlbear Hartshorn | Locked post-split evidence. |
| Slippery Syl Lonegan | Locked. |
| Fipps Chumlett | Locked post-split evidence. |
| Tam "Narwhal" Tate | Locked post-split evidence. |
| Ratline Rattsberger | Locked post-split evidence. |
| Barefoot Samms Toppin | Strong evidence / likely. |
| Shivikah | Strong evidence. |
| Jaundiced Jape | Locked post-split evidence. |
| Tilly Brackett | Locked aboard before abduction. |
| Sandara Quinn | Locked aboard before abduction. |
...
Working locked / strong Wormwood-origin transfer count: **18**.

## Probable / Unresolved Transfer Swing Slots

| Character | Current Handling |
|---|---|
| Badger Medlar | Probable Man's Promise-side, but low-placement confidence; if counted, transfer total becomes 19. |
| Jack Scrimshaw | Weak / possible displaced fragment; do not lock. |
| Conchobhar Turlach Shortstone | Placement unresolved. |
| Maheem | Placement unresolved. |
| Kipper | Placement unresolved. |
| Patch Patchsalt | Placement unresolved. |
