...
The Man's Promise is the captured merchant vessel that becomes the central political stage of the end of Book One.

In the published adventure, it is the prize ship that gives the PCs their first taste of piracy and eventually becomes their vessel after mutiny.

In Chronicles of Golarion, that outcome is not guaranteed.

The Man's Promise is not a reward. It is a contested state.

## Physical Description

The Man's Promise is a three-masted sailing ship, approximately 105 feet long and 30 feet wide.

It requires a minimum crew of 20 to sail effectively.

At the current point in the campaign, the ship has been damaged by storm and reef, suffered a grindylow raid, lost crew, and become a political prison as much as a vehicle.

## Published Baseline Function

The published adventure uses the Man's Promise to:

- introduce ship boarding,
- split the Wormwood crew,
- isolate Plugg from Harrigan,
- make mutiny possible,
...
The ship struck the coral around Bonewrack Isle.

The main hold or starboard side near the water stores was damaged.

Repairs are underway or recently underway, with crew assigned to repair tasks.

The original water supply was compromised, forcing the island supply mission.
...
- Food is needed.
- Coconuts and corn may be available from Bonewrack.
- The spring at Arron Ivy's stockade is the most reliable water source.
- The galley is functional but strained.
...
Plugg and Scourge may still believe Harvus and Mirei are dead, missing, or irrelevant depending on exact timing.

They may not yet know Sandara, Tilly, and Goyle survived.

This ignorance is tactically important.

## Current Political State

The ship contains overlapping factions rather than a unified crew.
...
This faction controls official force but may not control morale.

### Practical Survival Axis

- Ambrose Kroop
- possibly neutral sailors
- anyone focused primarily on food, water, repairs, and not dying

This faction may not want heroics but can decide whether the ship remains functional.

### PC / Ally Axis

Not yet unified.

Potential members include PCs, Sandara, Kroop, rescued prisoners, and any helpful or friendly sailors.

### Man's Promise Survivor Axis

Former Rahadoumi or Man's Promise crew may oppose Plugg and Scourge without forgiving the PCs.
...
Others may leave if given a chance.

## Key Locations

### Main Deck

Primary public space and likely site of confrontation, punishment, command announcements, and visible crew pressure.
...
Relevant to Goyle's capture and Plugg's pattern of making violence look accidental.

### Nameplate: The Motley

The ship has evidence of a prior name beneath Man's Promise: **the Motley**.
...
Do not assume the PCs take the ship.

Possible states include:

- PCs take control.
- Plugg keeps control but weakened.
- Scourge or another actor attempts control.
- An NPC is chosen as captain.
